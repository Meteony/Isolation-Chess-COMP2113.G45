...
int GameState::rows() const {
    return m_rows;
}

int GameState::cols() const {
    return m_cols;
}

bool GameState::inBounds(Coord here) const {
    int x = here.col; int y = here.row;
...
Side GameState::sideToMove() const {
    return m_sideToMove;
}

void GameState::setSideToMove(Side side) {
    m_sideToMove = side;
}
...
SessionStatus GameState::status() const {
    return m_status;
}

void GameState::setStatus(SessionStatus status) {
    m_status = status;
}

Side GameState::winner() const {
    return m_winner;
}

void GameState::setWinner(Side side) {
    m_winner = side;
}
