...
bool HumanPlayer::hasMoveReady() const { return m_moveReady; }
...
bool HumanPlayer::hasBreakReady() const { return m_breakReady; }
...
const Coord HumanPlayer::cursor() const { return m_cursor; }
